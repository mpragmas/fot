...
const Header = () => {
  return (
    <header className="text-whitish bg-light flex items-center justify-between px-5 py-3 font-extrabold sm:px-15 lg:px-20 lg:py-4">
      ...
      <div className="flex items-center gap-3 lg:gap-10">
        ...
        <IoSearch className="text-lightest text-xl lg:hidden" />
