            ...
            {transfers.map((t, index) => (
              <React.Fragment key={index}>
                <tr className="border-b border-gray-300 text-sm">
                  <td className="px-2 py-4 font-semibold">{t.player}</td>
                  <td className="px-2 py-4 font-extralight">{t.from}</td>
                  <td className="px-2 py-4 font-extralight">{t.to}</td>
                  <td className="px-2 py-4 font-extralight">{t.date}</td>
                  <td className="px-2 py-4 font-extralight">{t.fee}</td>
